<aside class="bg-gradient-to-b from-gray-800 to-gray-900 w-64 shadow-2xl fixed h-full overflow-y-auto transition-all duration-300 hover:shadow-purple-500/20 z-50">
    <!-- Logo/Header Section -->
    ...
    <nav class="p-4 space-y-1">
        ...
        <a href="{{ route('staff.dashboard') }}"
           class="flex items-center px-4 py-3 rounded-xl text-white hover:bg-gray-700/50 group transition-all duration-200
            ...
            <div class="p-2 mr-3 rounded-lg bg-gradient-to-br from-green-500 to-teal-400 group-hover:from-green-400 group-hover:to-teal-300">
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-2 gap-3 px-2">
                <div class="bg-gray-700/40 hover:bg-gray-700/60 backdrop-blur-sm p-3 rounded-xl border border-gray-600/30 transition-all duration-200 group">
            ...
            <div class="space-y-1">
                <a href="{{ route('staff.products.index') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-white hover:bg-gray-700/50 group transition-all duration-200
                    ...
                    <div class="p-2 mr-3 rounded-lg bg-gradient-to-br from-purple-500 to-indigo-400 group-hover:from-purple-400 group-hover:to-indigo-300">
                        <i class="fas fa-box-open text-white text-sm"></i>
                    </div>
                    <span class="font-medium">Lihat Produk</span>
                    <span class="ml-auto text-xs bg-purple-500/20 text-purple-300 px-2 py-1 rounded-full">{{ $totalProducts }}</span>
                </a>
                ...
                <a href="{{ route('staff.products.create') }}"
                   class="flex items-center px-4 py-3 rounded-xl text-white hover:bg-gray-700/50 group transition-all duration-200
                    ...
                    <div class="p-2 mr-3 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-400 group-hover:from-blue-400 group-hover:to-cyan-300">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                        ...
                        <a href="#" class="block px-3 py-2 text-sm text-gray-300 hover:bg-gray-700/50 rounded-lg hover:text-white transition-colors">
