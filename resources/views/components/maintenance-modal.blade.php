<!-- resources/views/components/maintenance-modal.blade.php -->
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                Maaf, saat ini fitur login dan registrasi menggunakan akun media sosial sedang dalam perbaikan.
                                Silakan gunakan metode login biasa untuk masuk ke akun Anda.
                            </p>
                        </div>
                    </div>
                </div>
