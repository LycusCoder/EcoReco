...
@section('content')
    <div class="container py-8">
        <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4 leading-relaxed">
                            ...
                            EcoReco didirikan pada tahun 2025 dengan tujuan untuk merevolusi pengalaman belanja online
                            melalui teknologi AI dan algoritma canggih.
                        </p>
                        <p class="text-gray-600 leading-relaxed">
                            Kami menggunakan Collaborative Filtering dan Apriori Algorithm untuk memberikan rekomendasi
                            produk yang relevan berdasarkan riwayat pembelian pengguna. Dengan ini, kami membantu pengguna
                            menemukan produk yang tepat dengan cepat dan efisien.
                    ...
                    <div
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Menggunakan Collaborative Filtering untuk memberikan rekomendasi
                                    produk yang relevan.</p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Mengidentifikasi pola pembelian umum menggunakan Apriori Algorithm.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Menyederhanakan proses pencarian produk dengan rekomendasi
                                    otomatis.</p>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Stat -->
            <div class="bg-blue-600 rounded-lg shadow-md mb-4 p-6">
                <h2 class="text-xl font-semibold mb-4 text-white flex items-center">
                    <i class="fas fa-chart-line mr-2"></i> Dalam Angka
                </h2>
                <div class="grid grid-cols-4 gap-4">
                    <!-- Produk Direkomendasikan -->
                    <div class="bg-white rounded-lg p-4 text-center">
                        <div
                            class="flex justify-center items-center w-12 h-12 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full mx-auto mb-4">
                            <i class="fas fa-box-open text-2xl text-white"></i>
                        </div>
                        <div class="text-3xl font-bold mb-2 gradient-text">
                            {{ number_format($stats['recommended_products']) }}+</div>
                        <div class="text-gray-600">Produk Direkomendasikan</div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4 text-center">
                        ...
                        <div class="text-3xl font-bold mb-2 gradient-text">{{ number_format($stats['active_users']) }}</div>
                    ...
                    <div class="bg-white rounded-lg p-4 text-center">
                        ...
                        <div class="text-3xl font-bold mb-2 gradient-text">{{ number_format($stats['business_partners']) }}
                        </div>
                    ...
                    <div class="bg-white rounded-lg p-4 text-center">
                        ...
                        <div class="text-3xl font-bold mb-2 gradient-text">{{ number_format($stats['products_sold']) }}
                        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 animate__animated animate__fadeIn">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach ($teamMembers as $member)
                <div class="text-center bg-gray-50 rounded-lg p-6 transition duration-300 hover:bg-white hover:shadow-md">
    ...
    <div
        ...
        <p class="mb-6 text-blue-100 max-w-2xl mx-auto">
            Bantu kami meningkatkan pengalaman belanja dengan memberikan masukan atau menjadi mitra dalam
            pengembangan sistem rekomendasi yang lebih cerdas.
        </p>
        <button
